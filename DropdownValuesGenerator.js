let setOptions=[
  ...
  let dropdownId="setSelect";
    setOptions.forEach(function(item,index){ setValues(dropdownId,item) });
  
    dropdownId="operatorSelect";
    operatorOptions.forEach(function(item,index){ setValues(dropdownId,item) });
  
    dropdownId="quantifierSelect";
    quantifierOptions.forEach(function(item,index){ setValues(dropdownId,item) });
